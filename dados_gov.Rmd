...
t10_uasgs %>%
  add_row( nome_uasg = 'Soma Total Quantidade', total = soma ) %>%
  gt() %>%
  tab_header(
...
t10_uasgs %>%
  add_row( nome_uasg = 'Soma Total Valores', `Total Valores` = soma ) %>%
  gt() %>%
  tab_header(
             title = "Dez maiores contratantes",
             subtitle = "Por Valores contratados"
             ) %>%
  fmt_currency(
...
t10_provider %>%
  ...
  tab_header(
             ...
             subtitle = "Por valores recebidos"
             ) %>%
  fmt_currency(
...
t10_providers_contracts %>%
  ...
  tab_header(
             ...
             subtitle = "Quantidade e soma de valores"
             ) %>%
  fmt_currency(
